...
async def loginHandler(c: Client, m: Message):
    ...
    if user.allowed:
        ...
        if passwd == Config.PASSWORD:
            ...
            await m.reply_text(
                text=f"**Login failed ❌,**\n  🛡️ Unfortunately you can't use me\n\Check: 🈲 https://t.me/HYBRID_Bots/63",
                quote=True,
            )
    user.set()
    del user
    ...
    if user.merge_mode == 4:
        ...
        if rmess.video or rmess.document:
            ...
            if file_name is None:
                await m.reply("File name not found; goto @HYBRID_Bots")
                return
...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/HYBRID_Bots")],
                [
                    InlineKeyboardButton(
    ...
    try:
        with userBot:
            userBot.send_message(
                ...
                text="Bot booted with Premium Account,\n\n  Thanks for using <a href='https://github.com/HYBRID_Bots/merge-bot'>this repo</a>",
